...
export const UNLOCK_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
...
>(
  input: UnlockAsyncInput<TAccountAuthority, TAccountConfig, TAccountAnalytics>,
...
export function getUnlockInstruction<
  ...
  TProgramAddress extends Address = typeof ANCHOR_AMM_PROGRAM_ADDRESS,
>(
  input: UnlockInput<TAccountAuthority, TAccountConfig, TAccountAnalytics>,
  config?: { programAddress?: TProgramAddress },
): UnlockInstruction<
  TProgramAddress,
  TAccountAuthority,
